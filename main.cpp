...
int main()
{
    ...
    //pruebo algun grupo con solo selecciones europeas 
    Equipo croacia       = crearEquipo(CROACIA,     "E");
    Equipo francia       = crearEquipo(FRANCIA,     "E");
    Equipo holanda       = crearEquipo(HOLANDA,     "E");
    Equipo polonia       = crearEquipo(POLONIA,     "E"); 
    ...
    //Test agregado 4 el vector tine mezcla entre europeas y americanas
    vector<Equipo> caso4;
    caso4.push_back(holanda);
    caso4.push_back(francia);
    caso4.push_back(argentina);
    caso4.push_back(croacia);
    caso4.push_back(chile);
    test("Caso 4", caso4);

    // solo europeas 
    vector<Equipo> caso5;
    caso5.push_back(polonia);
    caso5.push_back(francia);
    caso5.push_back(croacia);
    test("Caso 5", caso5);
